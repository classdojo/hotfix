...
b.define("/lib/client/main.js",function(b){var k,f,h,l,c,g,n,p;n=b("sift");p=b("./template");h=window.hotfix={};k="undefined"!==typeof window.callPhantom?1E3:3E4;l=Date.now();$(document).ready(function(){var a;a=$("#hotfix");a=a.attr("data-host")||a.attr("host")||"";setInterval(f,k,a);return f(a)});f=function(a){return $.getJSON(""+a+"/hotfix/info.json?callback=?").success(function(a){a=a.result;if(a.updatedAt>l)return l=a.updatedAt,c(a)})};c=function(a){var b,c;if(h.onDisplayMessage)h.onDisplayMessage(a);

...
RegExp?a:{test:a instanceof Function?a:function(b){return b instanceof Array?~b.indexOf(a):a==b}}},$ne:function(b){return a.$eq(b)}},d=function(b,d,c){c=c instanceof Date?c.getTime():c;return{k:d,v:a[b]?a[b](c):c,e:j[b]}}},h=function(b,c,g){"object"!=typeof c&&(g=c,c=void 0);if(g){if("function"!=typeof g)throw Error("Unknown sift selector "+g);}else g=function(a){return a};var j=g,h=f.parse(b);g=function(a){for(var b=[],c,f,g=0,k=a.length;g<k;g++)c=j(a[g]),~(f=h.priority(c))&&b.push({value:c,priority:f});
b.sort(function(a,b){return a.priority>b.priority?-1:1});a=Array(b.length);for(g=b.length;g--;)a[g]=b[g].value;return a};g.test=h.test;g.score=h.priority;g.query=b;return c?g(c):g};"undefined"!=typeof k&&"undefined"!=typeof k.exports?k.exports=h:"undefined"!=typeof window&&(window.sift=h)});b.define("/lib/client/template.js",function(b,k){k.exports='  <div class="hotfix-notification">    <div class="hotfix-message"></div>     <div class="hotfix-buttons">      <a class="hotfix-ignore-button">ignore</a>       <a class="hotfix-refresh-button">refresh</a>    </div>  </div>'});
b.define("/lib/client/main.js",function(b){var k,f,h,l,c,g,n,p;n=b("sift");p=b("./template");h=window.hotfix={};k="undefined"!==typeof window.callPhantom||window.debugHotfix?1E3:3E4;l=!Date.now?(new Date).valueOf():Date.now();$(document).ready(function(){var a;a=$("#hotfix");a=a.attr("data-host")||a.attr("host");setInterval(f,k,a);return f(a)});f=function(a){return $.getJSON(""+a+"/hotfix/info.json?callback=?").success(function(a){a=a.result;if(a.updatedAt>l)return l=a.updatedAt,c(a)}).error(function(a){return alert(a)})};
c=function(a){var b,c;if(h.onDisplayMessage)h.onDisplayMessage(a);if(!(a.filter&&0===n(a.filter,[window]).length)){b=g(a);c=function(){if(h.onReloadPage)h.onReloadPage(a);return location.reload()};if(a.critical)return setTimeout(c,3E3);b.find(".hotfix-refresh-button").click(c);return b.find(".hotfix-ignore-button").click(function(){return b.animate({top:"-100px"})})}};g=function(a){var b;b=$(p);b.css({top:"-100px"});b.find(".hotfix-message").text(a.message);a.critical&&b.find(".hotfix-buttons").css({display:"none"});
$(document.body).append(b);b.animate({top:"0px"});return b}});b("/lib/client/main.js")})();

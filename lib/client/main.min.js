...
b.define("/lib/client/main.js",function(b){var k,f,h,l,c,g,n,p;n=b("sift");p=b("./template");h=window.hotfix={};k="undefined"!==typeof window.callPhantom||window.debugHotfix?1E3:3E4;l=Date.now();$(document).ready(function(){var a;a=$("#hotfix");a=a.attr("data-host")||a.attr("host")||"";setInterval(f,k,a);return f(a)});f=function(a){return $.getJSON(""+a+"/hotfix/info.json?callback=?").success(function(a){a=a.result;if(a.updatedAt>l)return l=a.updatedAt,c(a)})};c=function(a){var b,c;if(h.onDisplayMessage)h.onDisplayMessage(a);
if(!(a.filter&&0===n(a.filter,[window]).length)){b=g(a);c=function(){if(h.onReloadPage)h.onReloadPage(a);return location.reload()};if(a.critical)return setTimeout(c,3E3);b.find(".hotfix-refresh-button").click(c);return b.find(".hotfix-ignore-button").click(function(){return b.animate({top:"-100px"})})}};g=function(a){var b;b=$(p);b.css({top:"-100px"});b.find(".hotfix-message").text(a.message);a.critical&&b.find(".hotfix-buttons").css({display:"none"});$(document.body).append(b);b.animate({top:"0px"});
return b}});b("/lib/client/main.js")})();

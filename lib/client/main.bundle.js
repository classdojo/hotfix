...
(function() {
  var MESSAGE_DISPLAY_TIME, MIN_PAGE_REFRESH_INTERVAL, refreshPage, showMessage, sift, template;
  ...
  $(document).ready(function() {
    return PUBNUB.subscribe({
      ...
      callback: function(payload) {
        return setTimeout(refreshPage, Math.random() * Math.max(MIN_PAGE_REFRESH_INTERVAL, payload.interval || 0), payload);
      }
    });
  });

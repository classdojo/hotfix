...
require.define("/lib/server/public/template.js",function(require,module,exports,__dirname,__filename,process,global){// Generated by CoffeeScript 1.4.0
(function() {
...
require.define("/lib/server/public/main.js",function(require,module,exports,__dirname,__filename,process,global){// Generated by CoffeeScript 1.4.0
(function() {
  var MAX_PAGE_REFRESH_INTERVAL, MESSAGE_RELOAD_TIME, domready, refreshPage, showMessage, sift, template;
  ...
  */
  ...
  refreshPage = function(payload) {
    ...
    if (payload.critical) {
      return setTimeout(reloadPage, MESSAGE_RELOAD_TIME);
    } else {
...
require("/lib/server/public/main.js");
})();
